...
\begin{enumerate}
	\item probability
	\item arrangement, permutation, combinations
	\item pascals identity and the binomial theorem
	\item logs and exponential functions 
	\item $A = P(1 + \frac{r}{n})^{nt} \Rightarrow A = Pe^{rt} \Rightarrow e = \lim_{n \to \infty}(1 + \frac{1}{n})^n$
	\item doubling time, half life,
	\item $e^{i\pi} + 1 = 0$, hyperbolic functions
	\item signed areas, area between curves, average value of a function, volumes of revolution
	\item numeric integration techniques, improper integrals, arc lengths
