...
limits and continuity revisited\\
...
factoring:	
	\begin{enumerate}
   		...
   		\item $x^2 + 6x + 9$
       		\item $4x^2 - 12x + 9$
	        \item $x^2 + 4x + 5$    % Not factorable over integers; good for completing the square
	        \item $x^2 - 10x + 29$  % Also best solved by completing the square
	\end{enumerate}

solving triangles:
\begin{enumerate}
        \item In triangle $ABC$, $A = 40^\circ$, $B = 65^\circ$, and $c = 12$. Find side $a$.
        \item In triangle $ABC$, $a = 10$, $b = 14$, and $C = 40^\circ$. Find side $c$ using the Law of Cosines.
        \item In triangle $ABC$, $a = 7$, $b = 9$, and $c = 10$. Find angle $A$.
        \item In triangle $ABC$, $A = 50^\circ$, $a = 12$, and $b = 10$. Find angle $B$.
        \item In triangle $ABC$, $a = 13$, $b = 15$, and $C = 70^\circ$. Find the area of the triangle.
        \item In triangle $ABC$, $A = 30^\circ$, $B = 45^\circ$, and $c = 18$. Find side $a$ and side $b$.
        \item In triangle $ABC$, $a = 8$, $b = 11$, and $c = 14$. Find all angles using the Law of Cosines.
        \item In triangle $ABC$, $A = 110^\circ$, $b = 20$, and $c = 25$. Find side $a$.
        \item In triangle $ABC$, $a = 16$, $b = 20$, and angle $C = 90^\circ$. Find side $c$ and angles $A$ and $B$. 
        \item In triangle $ABC$, $a = 9$, $b = 10$, $c = 11$. Find the area using Heron's Formula.
\end{enumerate}

solving triangles (ambiguous case SSA):
\begin{enumerate}
        \item Given triangle $ABC$ with $A = 30^\circ$, $a = 10$, and $b = 15$. Determine the number of possible triangles and find all possible solutions.
        \item In triangle $ABC$, $A = 50^\circ$, $a = 7$, and $b = 10$. Find how many triangles exist and solve for all possible angles and sides.
        \item For triangle $ABC$, $A = 40^\circ$, $a = 8$, and $b = 5$. Decide the number of triangles possible and solve if applicable.
        \item Given $A = 60^\circ$, $a = 9$, and $b = 9$. How many triangles can be formed? Find all solutions.
        \item In triangle $ABC$, $A = 25^\circ$, $a = 4$, and $b = 10$. Determine the possible number of triangles and solve accordingly.
        \item For triangle $ABC$, $A = 35^\circ$, $a = 12$, and $b = 7$. Analyze the number of triangles and solve.
        \item In triangle $ABC$, $A = 45^\circ$, $a = 5$, and $b = 6$. Find the number of possible triangles and all possible solutions.
        \item Given triangle $ABC$ with $A = 20^\circ$, $a = 3$, and $b = 8$. Determine how many triangles can be formed and solve.
        \item For triangle $ABC$, $A = 70^\circ$, $a = 15$, and $b = 12$. Find the number of possible triangles and solve accordingly.
        \item In triangle $ABC$, $A = 10^\circ$, $a = 2$, and $b = 5$. Determine the number of triangles possible and solve if any.
\end{enumerate}

polynomial long division (1. divide 2. multiply  3. subtract 4. repeat):
	\begin{enumerate}
...
synthetic division (1. multiply 2. divide 3. repeat): 
	\begin{itemize}
...
complex numbers (basic arithmetic operations and graphical manipulation)
\begin{enumerate}
    \item Simplify the following expression and write the result in the form $a + bi$: \\
    $(3 + 2i)(1 - 4i) - (2 - i)^2$

    \item Let $z = 5 - 3i$. Find:
    \begin{enumerate}
        \item The complex conjugate of $z$
        \item The modulus $|z|$
        \item The multiplicative inverse $\frac{1}{z}$
    \end{enumerate}

    \item Compute $(1 + i)^8$ and express your answer in the form $a + bi$. \\
    \textit{Hint: Convert to polar form first.}

    \item Find all cube roots of the complex number $8(\cos(\pi) + i\sin(\pi))$. \\
    Express your answers in both polar and rectangular form.

    \item Solve the quadratic equation $z^2 + 4z + 13 = 0$ and graph the solutions in the complex plane.
\end{enumerate}

\begin{enumerate}
    \setcounter{enumi}{5}

    \item Plot the following complex numbers on the complex plane: \\
    $A = 3 + 4i$, \quad $B = -2 + i$, \quad $C = 1 - 3i$ \\
    Also compute and plot: \\
    $A + B$, \quad $B - C$

    \item Let $z_1 = 2 + 2i$ and $z_2 = -2 + 2i$. Show that the triangle formed by $z_1$, $z_2$, and the origin is a right triangle. Justify your answer algebraically and graphically.

    \item Describe and sketch the locus of points $z$ in the complex plane such that $|z - (2 + i)| = 3$. \\
    \textit{Hint: This is a circle. State its center and radius.}

    \item Let $z = 4 + 4i$. Rotate $z$ by $90^\circ$ counterclockwise about the origin. Express the rotated point as a complex number and plot both the original and rotated points.

    \item Consider multiplication by $i$. For a general complex number $z = x + yi$, what is the result of $iz$? \\
    Describe the geometric transformation and illustrate it on the Argand diagram.
\end{enumerate}
