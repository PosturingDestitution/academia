...
\section*{introduction}
	...
	circle:
		\begin{itemize}	
			\item $C = 2\pi r$
			\item $A = \pi r^2$ how to get here using integration
		\end{itemize}
...
\textbf{factoring, completing the sqaure, quadratic formulae, fundamental theorem of algebra:}\\



\textbf{special factorizations, sum/difference of squares/cubes:}
	\begin{itemize}
...
\textbf{binomial, squares/cubes/ect of sums/differences, ect.:}
	\begin{itemize}
...
\textbf{matrices}\\
insert some information here dont overdo it now\\
$
\begin{bmatrix}
a & b\\
c & d
...
insert some basic infomration here dont over do this now
...
these are quite nice to proof geometrically... one thing to note is how similar the law of sins is to the pythagorean identity...now the law of cosines is for general triangle so obviously more information is needed\\
	$\frac{\sin(A)}{a} = \frac{\sin(B)}{b} \frac{\sin(C)}{c}$\\
	$a^2 = b^2 + c^2 - 2bc\cos(A)$\\
	you can use the law of cosines when you have two sides that sandwich an angle or when you have three sides and want to find an angle.
